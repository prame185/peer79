...
class Signaling {
  ...
  Future<void> connect() async {
    ...
    _socket.onOpen = () async {
      ...
      // Session session = await _createSession(
      //     peerId: '',
      //     sessionId: 'f7bf8fa8202189730649aa109e6016994833aaedee',
      //     media: null,
      //     screenSharing: true);
      // _sessions['f7bf8fa8202189730649aa109e6016994833aaedee'] = session;
      // _createOffer(session, null);

      // var peerId = 'f7bf8fa8202189730649aa109e6016994833aaedee';
      // var descrisption = data['msg']['offer'];
      // print("description:$description");
      // if (description != null) {
      //   var media = data['media'];
      //   var sessionId = data['from'];
